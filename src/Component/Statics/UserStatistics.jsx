...
const UserStatistics = () => {
  ...
  const { total, users, admins, restaurant } = stats;
    ...
    <div className=" px-4 py-12">
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          {/* Pie Chart */}
          <div className="bg-base-100 p-6 rounded-xl shadow-lg border border-blue-200">
            ...
            <div className="flex justify-center space-x-6 mt-4">
              <Legend color="green" label="Users" percentage={userPercentage} />
              <Legend color="purple" label="Admins" percentage={adminPercentage} />
              <Legend color="yellow" label="Restaurant" percentage={restaurantPercentage} />
            </div>
          </div>
        </div>
      )}
...
const StatCard = ({ title, value, icon }) => (
  <div className="bg-base-100 p-6 rounded-xl shadow-lg border border-blue-100 hover:shadow-xl transition-shadow">
...
const Legend = ({ color, label, percentage }) => (
  <div className="flex items-center">
    ...
    <span className="text-sm ">{label} ({percentage.toFixed(1)}%)</span>
  </div>
);
